...
class SoundEffects(Enum):
    PADDLE_BOUNCE = os.path.join(filepath, "original_pong_sounds/paddle_bounce.mp3")
    WALL_BOUNCE = os.path.join(filepath, "original_pong_sounds/wall_bounce.mp3")
    SCORE = os.path.join(filepath, "original_pong_sounds/score.mp3")
