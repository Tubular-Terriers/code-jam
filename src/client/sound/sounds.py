...
class SoundEffects(Enum):
    PADDLE_BOUNCE = os.path.join(filepath, "sound_effects/original_pong_sounds/paddle_bounce.mp3")
    WALL_BOUNCE = os.path.join(filepath, "sound_effects/original_pong_sounds/wall_bounce.mp3")
